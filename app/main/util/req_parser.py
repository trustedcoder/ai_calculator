...
payload_data.add_argument("operation_type",type=str,required=True,location="json",help="operation type should be subtraction, addition or multiplication, ",choices=list(['subtraction','addition','multiplication']))
